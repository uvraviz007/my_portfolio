        ...
        <div className="flex flex-col xl:flex-row gap-x-8">
          ...
          <div className="text-center flex xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
            ...
            <motion.p variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit="hidden" className="mb-4 maz-w-[400px] mx-auto lg:mx-0">
              I focus on building scalable systems and smart user-centric applications. My work spans distributed systems with authentication and encryption, MERN-stack platforms like Splitwise-style expense tracking and e-commerce systems, and AI/ML-driven features such as voice-controlled interfaces and machine-learning models for document understanding. I enjoy creating reliable backend logic,
               intelligent automation, and seamless frontend experiences that solve real-world problems.
